    ...
    <div className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFormData({ ...formData, proj_name: e.target.value })}
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {filteredProjects.map((project) => (
          <div key={project.proj_no} className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
            <div className="flex justify-between items-start mb-4">
              <div>
                <h3 className="text-lg font-semibold text-gray-900">{project.proj_name}</h3>
                <p className="text-sm text-gray-500">Project #{project.proj_no}</p>
              </div>
            ...
            <div className="space-y-2 text-sm text-gray-600">
              ...
              <div>
                <span className="font-medium">Department:</span> {project.dept_name}
              </div>
            </div>
          </div>
        ))}
